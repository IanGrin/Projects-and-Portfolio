...
class Board:
   def __init__(self):
       ...
       self.marked_space = lambda space: '\x1b[5;30;42m' + space + '\x1b[0m'

   def render_board(self):
       colored_B = '\x1b[5;30;41mB \x1b[0m'
       colored_I = '\x1b[5;30;43mI \x1b[0m'
       colored_N = '\x1b[5;30;44mN \x1b[0m'
       colored_G = '\x1b[5;30;45mG \x1b[0m'
       colored_O = '\x1b[5;30;47mO \x1b[0m'

       print(f"""
             ----------------
             |{colored_B}|{colored_I}|{colored_N}|{colored_G}|{colored_O}|
             ----------------
             ...
             ----------------
             |{self.column_one[2] if isinstance(self.column_one[2], str) else self.column_one[2] if self.column_one[2] >= 10 else str(self.column_one[2]) + " "}|{self.column_two[2]}|{self.marked_space('X ')}|{self.column_four[2]}|{self.column_five[2]}|
             ----------------
   ...
   def update_board(self, space):
       for index, num in enumerate(self.column_one):
           if num == space:
               self.column_one[index] = self.marked_space("X ")
       for index, num in enumerate(self.column_two):
           if num == space:
               self.column_two[index] = self.marked_space("X ")
       for index, num in enumerate(self.column_three):
           if num == space:
               self.column_three[index] = self.marked_space("X ")
       for index, num in enumerate(self.column_four):
           if num == space:
               self.column_four[index] = self.marked_space("X ")
       for index, num in enumerate(self.column_five):
           if num == space:
               self.column_five[index] = self.marked_space("X ")

   @staticmethod
   def check(board):
       # Space to find
       marked_space = '\x1b[5;30;42mX \x1b[0m'

       # Column Check
       if len(list(filter(lambda space: space == marked_space, board.column_one))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, board.column_two))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, board.column_three))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, board.column_four))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, board.column_five))) == 5:
           return True

       # Row Check
       if len(list(filter(lambda space: space == marked_space, [board.column_one[0], board.column_two[0], board.column_three[0], board.column_four[0], board.column_five[0]]))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, [board.column_one[1], board.column_two[1], board.column_three[1], board.column_four[1], board.column_five[1]]))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, [board.column_one[2], board.column_two[2], board.column_three[2], board.column_four[2], board.column_five[2]]))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, [board.column_one[3], board.column_two[3], board.column_three[3], board.column_four[3], board.column_five[3]]))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, [board.column_one[4], board.column_two[4], board.column_three[4], board.column_four[4], board.column_five[4]]))) == 5:
           return True

       # Diagonal Check
       if len(list(filter(lambda space: space == marked_space, [board.column_one[0], board.column_two[1], board.column_three[2], board.column_four[3], board.column_five[4]]))) == 5:
           return True
       if len(list(filter(lambda space: space == marked_space, [board.column_one[4], board.column_two[3], board.column_three[2], board.column_four[1], board.column_five[0]]))) == 5:
           return True
...
def start(player):
   ...
   while True:
       ...
       if again == "Y":
           ...
           if player.wallet == 0:
               print("But it looks like you're out of money...\n")
               time.sleep(1.5)

               if random.randint(1, 2) == 1:
                   print("Look, I feel bad for you... Here's an extra $100!\n")
                   player.wallet = 100
                   time.sleep(1.5)
               else:
                   print("Come back later when you have more money!")
                   break
